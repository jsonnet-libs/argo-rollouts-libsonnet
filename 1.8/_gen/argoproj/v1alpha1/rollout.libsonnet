      ...
      canary: {
        ...
        steps: {
          ...
          plugin: {
            ...
            withConfig(config): { plugin+: { config: config } },
            ...
            withConfigMixin(config): { plugin+: { config+: config } },
            '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        ...
        trafficRouting: {
          ...
          nginx: {
            ...
            '#withCanaryIngressAnnotations':: d.fn(help='', args=[d.arg(name='canaryIngressAnnotations', type=d.T.object)]),
            withCanaryIngressAnnotations(canaryIngressAnnotations): { spec+: { strategy+: { canary+: { trafficRouting+: { nginx+: { canaryIngressAnnotations: canaryIngressAnnotations } } } } } },
            '#withCanaryIngressAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='canaryIngressAnnotations', type=d.T.object)]),
            withCanaryIngressAnnotationsMixin(canaryIngressAnnotations): { spec+: { strategy+: { canary+: { trafficRouting+: { nginx+: { canaryIngressAnnotations+: canaryIngressAnnotations } } } } } },
