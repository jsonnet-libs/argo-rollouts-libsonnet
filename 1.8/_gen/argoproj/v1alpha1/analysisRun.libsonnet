{
  ...
  '#':: d.pkg(name='analysisRun', url='', help=''),
  ...
  '#new':: d.fn(help='new returns an instance of AnalysisRun', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  spec: {
    ...
    '#ttlStrategy':: d.obj(help=''),
    ttlStrategy: {
      '#withSecondsAfterCompletion':: d.fn(help='', args=[d.arg(name='secondsAfterCompletion', type=d.T.integer)]),
      withSecondsAfterCompletion(secondsAfterCompletion): { spec+: { ttlStrategy+: { secondsAfterCompletion: secondsAfterCompletion } } },
      '#withSecondsAfterFailure':: d.fn(help='', args=[d.arg(name='secondsAfterFailure', type=d.T.integer)]),
      withSecondsAfterFailure(secondsAfterFailure): { spec+: { ttlStrategy+: { secondsAfterFailure: secondsAfterFailure } } },
      '#withSecondsAfterSuccess':: d.fn(help='', args=[d.arg(name='secondsAfterSuccess', type=d.T.integer)]),
